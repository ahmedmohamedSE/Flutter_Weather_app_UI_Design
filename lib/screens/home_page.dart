...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    String cityName = "El Minya"; //city name
    int currTemp = 32; // current temperature
    int maxTemp = 36; // today max temperature
